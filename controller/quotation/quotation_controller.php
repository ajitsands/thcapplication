...
class apartmentController
{
    ...
    function __construct()
	{
		...
		$this->customer_name = $_POST['v_customer_name'];
		//echo $_POST['v_customer_name'];
		$this->po_box = $_POST['v_po_box'];
		$this->address = $_POST['v_address'];
		$this->contact_no = $_POST['v_contact_no'];
		$this->attension = $_POST['v_attension'];
		$this->quotation_date = $_POST['v_quotation_date'];
		$this->subject = $_POST['v_subject'];
		$this->description = $_POST['v_description'];
		$this->quantity = $_POST['v_quantity'];
		$this->unit = $_POST['v_unit'];
		$this->rate = $_POST['v_rate'];
		$this->vat_content = $_POST['v_vat_content'];
	
		$this->quotation_number = $_POST['v_quotation_number'];
		$this->total = $_POST['v_total'];
		$this->grand_total = $_POST['v_grand_total'];  
        $this->terms_and_condition = $_POST['v_terms_and_condition'];
        $this->created_by_id = $_POST['v_created_by_id'];
		$this->created_by_name = $_POST['v_created_by_name'];
		$this->approved_by_id = $_POST['v_approved_by_id'];
		$this->approved_by_name = $_POST['v_approved_by_name'];  
		//$this->refrence_number_first_part = $_POST['refrence_number_first_part'];
		$this->reference_number_date = $_POST['reference_number_date'];
		$this->quotation_child_id = $_POST['v_quotation_child_id'];
		$this->quotation_master_id = $_POST['v_quotation_master_id'];
		//$this->quotation_list_child_id = $_POST['v_quotation_child_list_id'];
		$this->quotation_list_child_id =$this->varDBConnection->real_escape_string($_POST['v_quotation_child_list_id']);
		
        $this->employee_action = $_POST['v_employee_action'];
        
        $this->quotation_start_date=$_POST['v_quotation_start_date'];
        $this->quotation_end_date=$_POST['v_quotation_end_date'];
        $this->quotation_customer_id=$_POST['v_quotation_customer_id'];
        
        $this->quotation_number_rivision=$_POST['v_quotation_number_rivision'];
