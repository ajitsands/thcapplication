...
class loginController 
{
    ...
    {
        $array =  array();
        $array[0] = "SELECT * FROM  tbl_customers where customer_code='".$this->username."' ";
        $array[1] = "UPDATE `tbl_customers` SET `customer_password`='".$this->password."' WHERE employee_id='".$this->customer_id."'";
    ...
    function RequestAccept($FunctionEvents)
    {
        ...
        switch ($FunctionEvents)
        {
            ...
            case 'login':
                //echo $var[0];
                $this->login_result = $this->varModelObj->userAuthenticationforcustomer($var[0],$this->password);
