...
// Your SQL query
$sql = "SELECT tbl_app_modules.ids, tbl_app_modules.module_name, module_permissions.ids AS subModuleID, module_permissions.module_permission_name
FROM tbl_app_modules LEFT JOIN module_permissions ON tbl_app_modules.ids = module_permissions.module_id WHERE module_permissions.`module_status` ='Yes'";

// $sql="SELECT tbl_app_modules.ids, CASE WHEN UPPER(tbl_app_modules.module_name) = 'AMC' THEN 'AMC' ELSE tbl_app_modules.module_name END AS module_name,
