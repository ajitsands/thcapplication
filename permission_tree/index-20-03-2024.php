    ...
    <div class="row">
        <div class="col-4">
            ...
            <div class="col-4">
                ...
                <div id="div_list_user_roles" style="padding:5px;margin-bottom:20px;border-width:1px;border-style:solid;border-color:#CECECE;"></div>
...
$(document).on("click", "#button_save_user_role", function() {
    ...
    if(typeof dataSelectedUser === 'undefined')
    {
    ...
    $.post('insert_user_roles.php',{user_role_data: jsonString,userID:dataSelectedUser},function(res){
        alert(res);
    });
});
