...
$result_amc_details = mysqli_query($varDBConnection, "SELECT * FROM tbl_customer_feedback_details WHERE form_number='".$form_number."' ");
?>
    ...
    function displaySingleSelection($questionNumber, $question_id, $question_name, $row_amc_details)
{
    ...
    $selectedValue = $row_amc_details['selected_option']; // Replace 'selected_option' with the actual column name in your database
                ...
                <div class="question-options card-footer">
                    <div class="row">
                        ...
                        foreach ($options as $index => $option) {
                            $isChecked = ($option == $selectedValue) ? 'checked' : '';
                            ?>
                            <div class="col-2">
                                <input type="radio"
                                       class="btn-check"
...
{
    $options = array($row_amc_details['q1'], $row_amc_details['q2'], $row_amc_details['q3'], $row_amc_details['q4'], $row_amc_details['q5'], $row_amc_details['q6']);
    $selectedValues = explode(',', $row_amc_details['selected_options']); // Replace 'selected_options' with the actual column name in your database
