 ...
 <div class="card">
			...
			<div id="collapsible-item-nested-date-<?php echo $dsl;?>" class="collapse ">
				<div class="card-body">
				    ...
				    //	$result = mysqli_query($varDBConnection,"SELECT distinct(GROUP_CONCAT(employee_name)) as Emp_name, GROUP_CONCAT(employee_id) as Emp_id,visit_id FROM  tbl_ticket_teams where ticket_team_status='Active' and visit_date = '".$row_date['visit_date']."' group by ");
				    	$result = mysqli_query($varDBConnection,"SELECT GROUP_CONCAT( employee_name) as Emp_name, GROUP_CONCAT( employee_id) as Emp_id,visit_id FROM  tbl_ticket_teams where ticket_team_status='Active' and visit_date = '".$row_date['visit_date']."' group by ticket_ref_no");
