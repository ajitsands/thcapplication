 ...
 while($row_entries=mysqli_fetch_assoc($result_entries)) { 
	        ...
	        $result_building_details = mysqli_query($varDBConnection,"select building_address,contact_person_name,contact_person_no from   tbl_customer_location where   customer_id=".$row_details['customer_id']." and location_id=".$row_details['location_id']." and building_id=".$row_details['building_id']."");
                     ...
                     while($row_building_details=mysqli_fetch_assoc($result_building_details)) { ?>
                             <tr>
                			<td style="text-align:center;font-weight:bold"><?php echo $j;?></td>
                			<td style="font-weight:bold"><?php echo $row_details['customer_name'];?></td>
                			<td style="font-weight:bold"><?php echo $row_details['building_name'].', '.$row_details['location_name'];?></td>
                		    <td style="font-weight:bold"><?php echo $row_building_details['building_address'];?></td>
                				<td style="font-weight:bold"><?php echo $row_building_details['contact_person_name'].', '.$row_building_details['contact_person_no'];?></td>
                									<td style="font-weight:bold"><?php if($row_entries['amc_ticket']=='AMC'){echo 'WO-'.$row_details['ticket_ref_code'].'-'.$row_entries['visit_id'];} else {echo 'WO-'.$row_details['ticket_ref_code'].'-'.$row_details['ticket_id'];} ?></td>
                                         ...
                                         $add_slots=$row_slots['additional_slots'];
                									...
                									<td style="font-weight:bold"><?php echo $row_entries['complaints_description'];?></td>
                										<td style="font-weight:bold"><?php echo $row_entries['asset_code'].' - '.$row_entries['additional_info'];?></td>
                								<td style="font-weight:bold"><?php echo $row_details['category_name'].' - '.$row_details['type_name'];?></td>
