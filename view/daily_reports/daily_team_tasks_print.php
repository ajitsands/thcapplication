...
<div class="report-container">
    ...
    <div style="display: none;">
        <table id="second_table">
            ...
            <tr><td>Date</td><td colspan="3"><?PHP echo date("d-m-Y",strtotime($_GET['start_date']));  ?></td></tr>
    ...
    <div class="details-grid">
        <div class="details-item">
            <label>Date</label>
            <div class="val"><?PHP echo date("d-m-Y",strtotime($_GET['start_date']));  ?></div>
        </div>
        <div class="details-item">
 ...
 while($row_entries=mysqli_fetch_assoc($result_entries)) { 
    ...
    <div class="signature-grid">
        ...
        <div class="signature-box">Operation Coordinator</div>
    </div>
