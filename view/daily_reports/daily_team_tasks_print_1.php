...
<table align="center" border="0" cellpadding="0" cellspacing="0" width="1000">
	<tbody>
		<tr >
			<td bgcolor="#2e2e79" colspan="12" style="color: #ffffff"><strong>DAILY TASKS DETAILS</strong></td>
		</tr>
		<tr bgcolor="#C1C1C1">
		    ...
		    <td width="158" style="text-align:center"><b>Duration </b></td>
		      <td width="158" style="text-align:center"><b>Job Description</b></td>
		    <td width="225" style="text-align:center"><b>Status </b></td>
		    <td width="225" style="text-align:center"><b>Remarks </b></td>
...
<?php
	...
	while($row_services=mysqli_fetch_assoc($result_services)) {
                     ...
                     ?>
                								...
                								<td><?php if($row_entries['amc_ticket']=='TKT'){ echo $job_description;} else { echo $row_services['service_description'];}?></td>		
