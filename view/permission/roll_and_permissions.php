        ...
        <div class="row">
            <div class="col-6">
             ...
             <div class="col-6">
                ...
                <div class="col-2 fixed-height-div" >
                    <div class="row">
                        <div class="col-12">
                ...
                <div class="col-2 fixed-height-div" style="padding-top: 20px;">
...
<script type="text/javascript" src="permission/js/jsfunctions.js?timestamp=<?php echo time(); ?>"></script>
