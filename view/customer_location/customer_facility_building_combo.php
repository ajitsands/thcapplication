...
$varDBConnection = $DBConn->ConnectToMYSQL();
	...
	$result_customer_building = mysqli_query($varDBConnection,"Select building_id,building_name,building_code from  tbl_building where building_status='Active' and building_id not in (select building_id from tbl_customer_location where customer_location_status='Active')");
