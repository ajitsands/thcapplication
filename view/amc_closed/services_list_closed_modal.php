 ...
 ?>
	<div class="row"> 
        										<div class="col-lg-12 col-md-12 col-sm-12">
        										  	 <?php $result_service_images = mysqli_query($varDBConnection,"select service_image_name from  tbl_service_images where amc_ticket='AMC' and  visit_id=".$_POST['visit_id']);
               ...
               $k=0;
                     ...
                     ?>
                								...
                								<tr>
                									...
                									<?PHP switch($row_services['amc_service_status'])
                									{
                									    case 'Pending': ?>
                									    <td ><span class="badge badge-warning"><?php echo $row_services['amc_service_status'];?></span></td>
                									  <?PHP break;
                									  case 'Start': ?>
                									    <td><span class="badge badge-info"><?php echo $row_services['amc_service_status'];?></span></td>
                									  <?PHP break;
                									  case 'Completed': ?>
                									    <td><span class="badge badge-success"><?php echo $row_services['amc_service_status'];?></span></td>
                									  <?PHP break;
                									  case 'Cancelled': ?>
                									    <td><span class="badge badge-danger"><?php echo $row_services['amc_service_status'];?></span></td>
                									  <?PHP break;
                									  default: ?>
                									    <td><span class="badge badge-secondary"><?php echo $row_services['amc_service_status'];?></span></td>
                									  <?PHP break;
                									} 
                									?>
