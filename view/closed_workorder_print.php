...
$sql = "SELECT *, 
        ...
        WHERE amc_ticket = 'TKT' 
          ...
          AND amc_visit_status = 'Closed' $where_cust 
...
$total_closed = count($visits_list);
...
<head>
    <meta charset="utf-8">
    <title>Closed Work Orders Report - (<?PHP echo $display_start; ?> to <?PHP echo $display_end; ?>)</title>
...
<div class="report-container">
    ...
    <div class="no-print" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 16px; border-bottom: 1px solid #e2e8f0; padding-bottom: 12px;">
        <div style="font-size: 12px; color: #64748b;">
            Document: <strong>Closed Work Orders Summary</strong>
        </div>
        ...
        <tbody>
            <tr>
                <td class="stat-box" style="width: 25%;">
                    <div class="stat-num" style="color: #15803d;"><?PHP echo $total_closed; ?></div>
                    <div class="stat-lbl">Total Closed</div>
                </td>
                <td class="stat-box" style="width: 25%;">
                ...
                if ($total_closed > 0) {
                    ...
                    <tr>
                        <td colspan="8" style="text-align: center; padding: 24px; color: #64748b; font-style: italic;">
                            No closed work orders found for the selected date range and filter.
                        </td>
                    </tr>
                    <?PHP 
                }
...
function fnExcelReport() {
    ...
    tab_text += "<tr><th colspan='8' style='background:#2e2e79;color:#ffffff;font-size:16px;padding:8px;'>CLOSED WORK ORDERS REPORT (" + <?php echo json_encode($display_start . ' to ' . $display_end); ?> + ")</th></tr>";
