							...
							<div class="col-md-12">
								...
								<div class="form-group row" id="div_options">
										...
										<div class="col-lg-2 col-md-2 col-sm-12" >
    										...
    										<input type="hidden" class="form-control" id="txt_question1_id"  tabindex=2>
    									</div>																
										<div class="col-lg-2 col-md-2 col-sm-12" >
    										...
    										<input type="hidden" class="form-control" id="txt_question2_id" placeholder="" tabindex=2>
    									</div>
    								    <div class="col-lg-2 col-md-2 col-sm-12" >
    										...
    										<input type="hidden" class="form-control" id="txt_question3_id" placeholder="" tabindex=2>
    									</div>
    									<div class="col-lg-2 col-md-2 col-sm-12" >
    										...
    										<input type="hidden" class="form-control" id="txt_question4_id" placeholder="" tabindex=2>
    									</div>
    									<div class="col-lg-2 col-md-2 col-sm-12" >
    										...
    										<input type="hidden" class="form-control" id="txt_question5_id" placeholder="" tabindex=2>
    									</div>
    									<div class="col-lg-2 col-md-2 col-sm-12" >
    										...
    										<input type="hidden" class="form-control" id="txt_question6_id" placeholder="" tabindex=2>
    									</div>
