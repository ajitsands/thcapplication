...
<table align="center" border="0" cellpadding="0" cellspacing="0" width="800">
	<tbody>
		...
		<tr>
			...
			<td bgcolor="#2e2e79" style="text-align: center;color:white;width:20%;"> <strong>Asset Name</strong></td>
			<td bgcolor="#2e2e79" style="text-align: center;color:white;width:15%;"><strong>Category</strong></td>
			<td bgcolor="#2e2e79" style="text-align: center;color:white;width:15%;"><strong>Description</strong></td>
	...
	else
	{
	    ...
	    <tr style="border-bottom: 1px solid gray;">
			...
			<td bgcolor="#f2f2f2" style="text-align: center"><?PHP echo $child_row['asset_sp_des']; ?></td>
			<td bgcolor="#f2f2f2" style="text-align: center"><?PHP echo $child_row['asset_category_name']; ?></td>
			<td bgcolor="#f2f2f2" style="text-align: center"><?PHP echo $child_row['asset_description']; ?></td>
