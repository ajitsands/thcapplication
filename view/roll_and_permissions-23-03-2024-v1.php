        ...
        $("#tree").fancytree("getTree").reload({ url: fileName });
                ...
                //				data.node.toggleSelect();
                			...
                			select: function(event, data) {
                                ...
                                //             $.post('../permission_tree/add_main_modules.php',
                                //             { action:"insert_module_name", moduleName:formatted_string, moduleId:parentNodeID, rollId:dataValueOfRole },
                                //             function(res){
                                //                  $('#loadingWrapper').hide();
                                //                 setupDropdown('dropdownContent','success','Main Module Selected','click');
                                //             });
                                //          }
                                //          else
                                //          {
                                //               $.post('../permission_tree/add_main_modules.php',
                                //                 { action:"delete_module_name", moduleName:formatted_string, moduleId:parentNodeID, rollId:dataValueOfRole },
                                //                 function(res){
                                //                      $('#loadingWrapper').hide();
                                //                   setupDropdown('dropdownContent','error','Main Module Deselected','click');
                                //                 });
                                //          }
                                //   } 
                ...
                //                 data.node.span.find('.fancytree-checkbox').css('background-image', 'none');
                //             }
...
function updateParentTitle(parentNode,parentTitleFromSelect,parentIdFromSelect) {
    ...
    if (parentNode) {
        ...
        //parentTitleFromSelect,parentIdFromSelect
            ...
            // if(selectedCount==1) // To Add Dynamicaly add the parent Node to The Table 
            // {
            //     $('#loadingWrapper').show();
            //     if(dataValueOfRole===undefined)
            //     {
            //         //setupDropdown('dropdownContent','error','Please select a user !','click');
            //         swal('Select User Type','Please select a user type!','warning');
            //         $('#loadingWrapper').hide();
            //         return false;
            //     }
            //     $.post('../permission_tree/add_main_modules.php',
            //     { action:"insert_module_name", moduleName:formatted_string, moduleId:parentIdFromSelect, rollId:dataValueOfRole },
            //     function(res){
            //          $('#loadingWrapper').hide();
            //          setupDropdown('dropdownContent','success','Main Module Selected','click');
            //     });
            ...
            // if(selectedCount==0) // To Delete Dynamicaly add the parent Node to The Table 
            // {
            //   $('#loadingWrapper').show();
            //     if(dataValueOfRole===undefined)
            //     {
            ...
            //     }
            //     $.post('../permission_tree/add_main_modules.php',
            //         { action:"delete_module_name", moduleName:formatted_string, moduleId:parentIdFromSelect, rollId:dataValueOfRole },
            //         function(res){
            //             $('#loadingWrapper').hide();
            //             setupDropdown('dropdownContent','error','Main Module Deselected','click');
            //     });
