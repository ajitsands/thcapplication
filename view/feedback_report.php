		...
		<div class="content-wrapper">
			...
			<div class="content pt-0">
				...
				<?PHP 
					...
					//include_once('customer/feedback_details_copy.php');
					//include_once('../customer_feedback/feedback_form_search.php');
				?>
				
				<div id="div_feedback_form_search">
				<?PHP 
					//include_once('amc/amc_details.php');
					//include_once('customer/feedback_details_copy.php');
					include_once('../customer_feedback/generate_report1.php');
				?>
				</div>
...
<script>
    $(document).ready(function(){
        // var jsonData = '<?php //echo json_encode($textResponses); ?>';
        // console.log(jsonData);
        // $.post('../customer_feedback/sentiment_analysis_google.php',{ arrayval : jsonData }, function(res){
        //   $('#google_sentimentals').html(res);
        // });
        
        
        $.post('../customer_feedback/sentiment_analysis_google.php',{arrayval : <?php echo json_encode($textResponses); ?> }, function(res){
          $('#google_sentimentals').html(res);
        });
        
        $("#btn_feedback_search").click(function(){
            var v_amc_ref_no= $("#amc_ref_no option:selected").val();
            var v_type= $("#amc_ref_no option:selected").val();
            //alert(v_amc_ref_no);
            $('#div_feedback_form_search').load('../customer_feedback/generate_report1.php',{amc_no:v_amc_ref_no},function(response,status,xhr){
