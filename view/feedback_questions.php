...
<head>
	...
	<script src="../httpdocs/user_js/feedback_questions_v1.js"></script>
...
<body class="navbar-top">
	...
	<div class="content-wrapper" style="margin-left:0;padding:20px 24px 0;">
			...
			<div class="content pt-0">
				...
				<?PHP 
					//include_once('customer/feedback_questions_details.php');
					include_once('customer/feedback_questions_details_v1.php');
