...
<head>
	...
	<style>
        ...
        #list_of_services_wrapper .dataTables_length {
            float: left !important;
            display: inline-flex !important;
            align-items: center !important;
            margin-bottom: 12px !important;
        }
        #list_of_services_wrapper .dataTables_filter {
        ...
        #list_of_services_wrapper .dataTables_filter label {
            display: inline-flex !important;
            align-items: center !important;
            justify-content: flex-end !important;
            margin-bottom: 0 !important;
        }
        #list_of_services_wrapper:after {
            content: "" !important;
	...
	<script src="../httpdocs/user_js/services.js"></script>
...
<body class="navbar-top">
	...
	<div class="content-wrapper" style="margin-left:0;padding:20px 24px 0;">
			...
			<div class="content pt-0">
				...
				<?PHP 
					include_once('services/service_details.php');
				?>
