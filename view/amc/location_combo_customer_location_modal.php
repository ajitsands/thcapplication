...
//$varDBConnection = $DBConn->ConnectToMYSQL();
 	$result_location_for_customer_location = mysqli_query($varDBConnection,"select location_id,location_name,location_code from  tbl_location "); 	
?>


     <select data-placeholder="Select location" id="select_location_for_customer_location" class="form-control form-control-select2" data-fouc>
