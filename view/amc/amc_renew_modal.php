							...
							<div class="col-md-12">
								<div class="form-group row">
									...
									<span class="form-text text-muted" style='font-size: 12px;'><font color="black">AMC Signed Date</font></span> 
										<input type="text" class="form-control " id="txt_amc_signed_date1" disabled>
									</div>
									<div class="col-lg-2 col-md-2 col-sm-2">
									...
									<div class="col-lg-2 col-md-2 col-sm-2">
										...
										<input type="text" class="form-control " id="txt_amc_amount1" disabled>
									</div>
									<div class="col-lg-2 col-md-2 col-sm-2">
									...
									<div class="col-lg-2 col-md-2 col-sm-2">
										...
										<input type="text" class="form-control " id="txt_amc_vat_amount1" disabled>
									</div>
								</div>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="row" id = "div_subcontractor_content">
							<div class="col-md-12">
								<div class="form-group row">
									<div class="col-lg-5 col-md-5 col-sm-5" id="div_subcontractors_load1" >
									...
									<div class="col-lg-12 col-md-12 col-sm-12">
										...
										<input type="file" class="form-input-styled"  id="session_image1" accept="image/*" title="&nbsp;" tabindex=7 data-fouc=""/><p id="amc_contractor_file_name1"></p>
										<div id="img_preview1" style="width:40px;height:40px;padding-top:5px;"> </div>
									</div>
