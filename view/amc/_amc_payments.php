<div id="modal_backdrop_amc_payments1" class="modal fade" data-backdrop="false" tabindex="-1">
					<div class="modal-dialog modal-lg">
						<div class="modal-content">
							...
							<div class="modal-body">
                                ...
                                <input class="form-control" type="hidden" id="txt_cust_ref_no_payments">                               
                                    ...
                                    <div class="col-lg-3 col-md-12 col-sm-12" >
        										<input class="form-control" type="date" name="date" id="txt_payment_date">
        										<span class="form-text text-muted"> Date &nbsp;<span style="color:red;">*</span></span>
							        </div>
                                    
									<div class="col-lg-2 col-md-12 col-sm-12" >
						                        <div class="input-group">
													<input type="text" id="txt_payment_amount" class="form-control form-control-lg text-center" placeholder="Amount" onkeypress='return event.charCode == 46 || (event.charCode >= 48 && event.charCode <= 57)' onpaste="return false" align="center" autocomplete="off">
				    	    ...
				    	    <div class="col-lg-2 col-md-12 col-sm-12" >
					                <div class="input-group">
													<input type="text" id="txt_payment_vat_per"  class="form-control form-control-lg text-center" placeholder="VAT %" align="center" onkeypress='return event.charCode == 46 || (event.charCode >= 48 && event.charCode <= 57)' onpaste="return false" align="center" autocomplete="off">
						    ...
						    <div class="col-lg-2 col-md-12 col-sm-12" >
						            <div class="input-group">
													<input type="text" id="txt_payment_vat_amount" class="form-control form-control-lg text-center" placeholder="0.000" align="center" autocomplete="off" disabled>
                            ...
                            <div class="col-lg-2 col-md-12 col-sm-12" >
						            <div class="input-group">
													<input type="text" id="txt_amc_vat_amount" class="form-control form-control-lg text-center" placeholder="0.000" align="center" autocomplete="off" disabled>
                                ...
                                <div class="col-lg-3 col-md-12 col-sm-12" style="padding-top:10px" >
                                               ...
                                               <div class="form-check">
                                                   <label class="form-check-label">
                                                       ...
                                                       Company Closing Entry
                                                   </label>
                                               </div>
                                               </div>
    						        <div class="col-lg-2 col-md-12 col-sm-12" >
        										<input class="form-control" type="text" name="txt_invoice_ref_no" id="txt_invoice_ref_no" placeholder="Invoice Ref No">
        										<span class="form-text text-muted" placeholder="Invoice No"> Invoice Ref No</span>
							        </div>
    					                 <div class="col-lg-4 col-md-12 col-sm-12"  >
    										<textarea rows="1" class="form-control elastic" placeholder="Description" id="txt_payment_description"></textarea>
