...
<head><meta charset="us-ascii">
	<title>Visa Expiry Employee List</title>
...
<table align="center" style="border: none;" width="1000" >
	<tbody>
		...
		<tr style="border: none;">
			<td style="border: none;"><b>Visa Expired Employees List As On : <?php echo date("d-m-Y", strtotime($_GET['search_date']));?></b></td>
...
<table align="center" width="1000"  id="main_table">
	<tbody style="padding-bottom: 200px;" height="0px">
		...
		<tr>
			...
			<td bgcolor="#1b2441"  style="color: #daa505;text-align: center;" width="100"><b>CPR No.</b></td>
				<td bgcolor="#1b2441"  style="color: #daa505;text-align: center;" width="100"><b>Visa Type</b></td>
			<td bgcolor="#1b2441"  style="color: #daa505;text-align: center;" width="300"><b>Visa Expiry Date</b></td>
				<td bgcolor="#1b2441"  style="color: #daa505;text-align: center;" width="100"><b>Status</b></td>
		</tr>
		
	<?PHP 
	
        $result = mysqli_query($varDBConnection,"select *,DATE_FORMAT(visa_validity_on,'%d/%m/%Y') as visa_validity_on_format,DATE_FORMAT(joining_date, '%d/%m/%Y') as joining_date from 	view_employee_expertiser_list where visa_validity_on < '".$_GET["search_date"]."' order by employee_name asc");
	...
	<tr>
	        ...
	        <td style="text-align: left;" width="400"><?PHP echo $row['visa_validity_on_format']; ?></td>
