...
$sql = "SELECT *, 
        ...
        WHERE amc_ticket = 'TKT' 
          ...
          AND amc_visit_status = 'Extended' $where_cust 
...
$total_extended = count($visits_list);
...
<head>
    <meta charset="utf-8">
    <title>Extended Work Orders Report - (<?PHP echo $display_start; ?> to <?PHP echo $display_end; ?>)</title>
...
<div class="report-container">
    ...
    <div class="no-print" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 16px; border-bottom: 1px solid #e2e8f0; padding-bottom: 12px;">
        <div style="font-size: 12px; color: #64748b;">
            Document: <strong>Extended Work Orders Summary</strong>
        </div>
        ...
        <tbody>
            <tr>
                ...
                <td style="border: none; padding: 0; width: 50%; text-align: right; vertical-align: middle;">
                    <div style="font-size: 18px; font-weight: 700; color: #2e2e79; letter-spacing: 0.5px;">EXTENDED WORK ORDERS REPORT</div>
        ...
        <tbody>
            <tr>
                <td class="stat-box" style="width: 25%;">
                    <div class="stat-num" style="color: #86198f;"><?PHP echo $total_extended; ?></div>
                    <div class="stat-lbl">Total Extended</div>
                </td>
                <td class="stat-box" style="width: 25%;">
                ...
                if ($total_extended > 0) {
                    ...
                    <tr>
                        <td colspan="8" style="text-align: center; padding: 24px; color: #64748b; font-style: italic;">
                            No extended work orders found for the selected date range and filter.
                        </td>
                    </tr>
                    <?PHP 
                }
...
function fnExcelReport() {
    ...
    tab_text += "<tr><th colspan='8' style='background:#2e2e79;color:#ffffff;font-size:16px;padding:8px;'>EXTENDED WORK ORDERS REPORT (" + <?php echo json_encode($display_start . ' to ' . $display_end); ?> + ")</th></tr>";
    ...
    if (msie > 0 || !!navigator.userAgent.match(/Trident.*rv\:11\./)) {
        ...
        txtArea1.contentWindow.document.execCommand("SaveAs", true, "Extended_Work_Orders_Report.xls");
        document.body.removeChild(txtArea1);
    } else {
        var a = document.createElement('a');
        var data_type = 'data:application/vnd.ms-excel,' + encodeURIComponent(tab_text);
        a.href = data_type;
        a.download = "Extended_Work_Orders_Report_" + <?php echo json_encode(date("d_m_Y")); ?> + ".xls";
