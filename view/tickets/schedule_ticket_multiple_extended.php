		...
		<div class="modal-content">
				...
				<div class="modal-body" style="max-height: 70vh; overflow-y: auto; overflow-x: hidden;">
				      <div class="row">
                             	...
                             	<input type="hidden" id="txt_vist_start_time_hidden_multiple"/>
                             	  <div class="col-lg-12 col-md-12 col-sm-12" >
                        			 <table class="table datatable-selection-single" id="tbl_ticket_schedule_category_list_multiple_extended" style="padding-right:10px;padding-left:10px;">
                        						<thead>
                        							<tr>
                        							    <th></th>
                        							    <th>Work Order No.</th>
				      ...
				      <div class="row">
									...
									<select  class="form-control" id="select_slots_multiple_extended" name="select_slots_multiple_extended">
									...
									<select  class="form-control"   name="duration_multiple" id="duration_multiple" ><option value="0" selected>0</option><option value="1" >1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option><option value="10">10</option><option value="11">11</option><option value="12">12</option><option value="13">13</option><option value="14">14</option><option value="15">15</option><option value="16">16</option><option value="17">17</option><option value="18">18</option><option value="19">19</option><option value="20">20</option><option value="21">21</option><option value="22">22</option><option value="23">23</option></select>
									</div>
