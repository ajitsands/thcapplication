...
?>
	...
	<span class="form-text text-muted font-weight-bold"><font color="black">Asset Category&nbsp;<span style="color:red;">*</span> </font></span>
                                 <select class="form-control form-control-select2 categoryassettype" id="select_category_asset_type" data-placeholder="Select Category" data-fouc>
