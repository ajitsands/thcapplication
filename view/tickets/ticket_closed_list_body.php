...
<!--	</div>-->
<?php include('view_ticket_modal_closed.php');?>
<?php include('view_visit_closed_modal.php');?>
<?php include('view_services_closed_modal.php');?>
	<div class="card">
				<div class="card-header header-elements-inline">
						<h5 class="card-title">List of Closed Work Orders</h5>
						<div class="header-elements">
