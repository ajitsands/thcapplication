...
?>
	...
	<span class="form-text text-muted font-weight-bold"><font color="black">Asset Category&nbsp;<span style="color:red;">*</span> </font></span>
                                 <select class="form-control form-control-select2 categoryservices" id="select_category_add_services" data-placeholder="Select Category" data-fouc>
