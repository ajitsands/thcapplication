						...
						<div class="modal-content">
							<div class="modal-header bg-info">
								...
								<div id="selected_items" style="font-size:15px;color:red;padding-top:2px;"></div>
									<button type="button" class="bg-pink-400 btn-icon rounded-round" data-toggle="modal" data-target="#modal_add_entries" data-popup="tooltip" title="Add New Entries" data-placement="bottom" id="btn_add_new_tkt_entries"><i class="icon-folder-plus"></i></button>
...
<!--Second table-->
   <div class="row">
    					...
    					<div class="card-body" >
    					    ...
    					    <input type="file" class="form-input-styled"  id="session_image3" accept="image/*" title="&nbsp;" data-fouc=""/>
    				        <b><i id="btn_remove_ticket_image3" data-popup="tooltip" title="Remove Image" data-placement="bottom" class="icon-cancel-circle2"></i></b>
        					    <!--<div id="img_preview" style="width:40px;height:40px;padding-top:5px;"> </div>-->
                            ...
                            <div class="col-md-1 col-sm-4">
								<div class="d-flex align-items-center" style="padding-top:30px">
									<i class="icon-image4 mr-3 icon-2x" id="i_image3" data-popup="tooltip" title="View Image" data-placement="bottom"></i>
									<input type="hidden" name="txt_hidden_ticket_image3" id="txt_hidden_ticket_image3" >
				 ...
				 <div class="row">
				   ...
				   <div class="row">
				       <div class="col-lg-2 col-md-6 col-sm-12" >
                        ...
                        <div class="col-lg-2 col-md-6 col-sm-12" style="padding-top:8px;display:none">
							<div class="form-check">
								<label class="form-check-label">
						...
						<div class="col-lg-2 col-md-6 col-sm-12" style="padding-top:8px;">
						 ...
						 <div class="col-lg-2 col-md-6 col-sm-12" style="padding-top:8px;display:none">
							<div class="form-check">
								<label class="form-check-label">
									<input type="radio" name="radio-styled-color1" class="form-check-input" checked=""  value="Others">
									Others
								</label>
							</div>
						</div>
						...
						<div class="col-lg-3 col-md-12 col-sm-12" >
								<input class="form-control" type="text" name="txt_quote_ref_no1" id="txt_quote_ref_no1" placeholder="Quotation Ref. No." >
					...
					<div class="row">
							...
							<div class="col-lg-12 col-md-12 col-sm-12">
				        	   	<span class="form-text text-muted font-weight-bold"><font color="black">Complaints&nbsp;</font></span>
									<textarea cols="2" class="form-control" id="txt_complaints1" name="txt_complaints1" placeholder="Complaints"></textarea>
					  ...
					  <div class="row">
				        	...
				        	<div class="col-lg-6 col-md-6 col-sm-12">
				        	    <table class="table datatable-selection-single" id="tbl_ticket_all_services">
            						<thead>
            							<tr>
            							    <th>Select Services from the list to add to the work order (if any)</th>
