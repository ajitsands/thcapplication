...
<?php include('view_ticket_modal.php');?>
<?php include('schedule_ticket_modal.php');?>
<?php include('change_status_ticket_modal.php');?>
<?php include('ticket_entry_cancel_modal.php');?>
<?php include('view_services_modal.php');?>
<?php include('add_new_ticket_entry_modal.php');?>
<?php include('schedule_ticket_multiple.php');?>
<?php include('view_services_modal_multiple.php');?>
<?php include('view_tech_expertise_modal_multiple.php');?>
<?php include('technician_schedules_modal_multiple.php');?>

	<div class="card">
				<div class="card-header header-elements-inline">
						<h5 class="card-title">List of Opened Work Orders</h5>
