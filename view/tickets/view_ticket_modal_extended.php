...
<!--Second table-->
   <div class="row">
				        	...
				        	<div class="col-lg-12 col-md-12 col-sm-12">
				        	   	<span class="form-text text-muted"><font color="black" style="font-weight:bold">Additional Info &nbsp;</font></span> 
					...
					<div class="row">
							...
							<div class="col-lg-12 col-md-12 col-sm-12">
				        	   	<span class="form-text text-muted font-weight-bold"><font color="black">Complaints&nbsp;</font></span> 
									<textarea rows="1" class="form-control" id="txt_complaints1" name="txt_complaints1" placeholder="Complaints"></textarea>
