...
<?php include('view_ticket_modal_completed.php');?>
...
<!--	</div>-->
	...
	<div class="card">
				<div class="card-header header-elements-inline">
						<h5 class="card-title">List of Completed Work Orders</h5>
						<div class="header-elements">
				...
				<div class="card" style="overflow:auto;">
					<table class="table datatable-selection-single table-hover datatable-highlight listAction" id="tbl_completed_tickets">
						<thead>
							<tr>
