    ...
    <div class="modal-dialog modal-lg" style="width:90% !important; max-width:90% !important;">
		<div class="modal-content">
				...
				<div class="modal-body" style="max-height: 70vh; overflow-y: auto; overflow-x: hidden;">
				      ...
				      <div class="row">
								    ...
								    <label>Time Slot</label>
									   <select  class="form-control" id="select_slots_multiple_update" name="select_slots_multiple_update">
				...
				<div class="modal-footer">
									<button type="button" id="btn_update_schedule" class="btn bg-teal"  >Update Schedule </button>
