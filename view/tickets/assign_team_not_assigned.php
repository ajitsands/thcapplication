				      ...
				      <div class="row">
                             	...
                             	<!--<input type="hidden" id="txt_vist_start_time_hidden_multiple"/>-->
                             	  <div class="col-lg-12 col-md-12 col-sm-12" >
                        			 <table class="table datatable-selection-single" id="tbl_ticket_assign_category_list_multiple_extended" style="padding-right:10px;padding-left:10px;">
                        						<thead>
                        							<tr>
                        							    <th></th>
                        							    <th>Work Order No.</th>
            				   ...
            				   <div class="row">
            				       ...
            				       <button type="button" id="btn_view_tech_avail_assign" class="btn btn-link"  >Show Available Technicians </button>
            				       </div>
            				   </div>
                              
								<div class="row" id="div_tech_list" >
