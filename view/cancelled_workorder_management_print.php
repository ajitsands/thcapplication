...
<table align="center" border="0" cellpadding="0" cellspacing="0" width="800">
	<tbody>
		<tr>
			<td bgcolor="#2e2e79" colspan="4" rowspan="3" style="color: #ffffff"><strong>List of Work Order - Cancelled</strong></td>
		</tr>
	</tbody>
</table>
<p></p>
...
<table align="center" border="0" cellpadding="0" cellspacing="0" width="800">
	<tbody>
		...
		<tr>
			...
			<td bgcolor="#2e2e79" style="text-align: center;color:white;width:10%;"><strong>Cancelled On</strong></td>
			<td bgcolor="#2e2e79" style="text-align: center;color:white;width:10%;"><strong>Reason</strong></td>
		</tr>
		 <?PHP 
	    ...
	    <tr style="border-bottom: 1px solid gray;">
			...
			<td bgcolor="#f2f2f2" style="text-align: center"><?PHP echo $child_row['cancelled_date_time1'] ; ?></td>
			<td bgcolor="#f2f2f2" style="text-align: center"><?PHP echo $child_row['cancelled_reason'] ; ?></td>
	    </tr>
