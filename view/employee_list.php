...
<table align="center" style="border: none;" width="1000" >
	<tbody>
		...
		<tr style="border: none;">
			<td style="border: none;"><b>EMPLOYEE LIST</b></td>
...
<table align="center" width="1000"  id="main_table">
	<tbody style="padding-bottom: 200px;" height="0px">
		...
		<tr>
			...
			<td bgcolor="#2e2e79"  style="color: #ffffff;text-align: center;" width="400"><b>Expertise</b></td>
			<td bgcolor="#2e2e79"  style="color: #ffffff;text-align: center;" width="100"><b>Contact No.</b></td>
			<td bgcolor="#2e2e79"  style="color: #ffffff;text-align: center;" width="300"><b>Date of Join</b></td>
			
			<td bgcolor="#2e2e79"  style="color: #ffffff;text-align: center;" width="100"><b>CPR No.</b></td>
			<td bgcolor="#2e2e79"  style="color: #ffffff;text-align: center;" width="100"><b>Passport No.</b></td>
			<td bgcolor="#2e2e79"  style="color: #ffffff;text-align: center;" width="100"><b>Visa Type</b></td>
			<td bgcolor="#2e2e79"  style="color: #ffffff;text-align: center;" width="100"><b>Blood Group</b></td>
				<td bgcolor="#2e2e79"  style="color: #ffffff;text-align: center;" width="100"><b>Status</b></td>
		</tr>
		
	<?PHP 
	 // $result = mysqli_query($varDBConnection,"select *,DATE_FORMAT(joining_date,'%d-%m-%Y') as joining_date,DATE_FORMAT(cpr_expiry_date,'%d-%m-%Y') as cpr_expiry_date,DATE_FORMAT(visa_validity_on,'%d-%m-%Y') as visa_validity_on from  view_employee_expertiser_list where employee_status='Active' and employee_id=".$_GET["employee_id"]);
    if($_GET["v_employee_type_id"]=='All')
   {
        $result = mysqli_query($varDBConnection,"select *,DATE_FORMAT(joining_date, '%d/%m/%Y') as joining_date,DATE_FORMAT(cpr_expiry_date, '%d/%m/%Y') as cpr_expiry_date,DATE_FORMAT(visa_validity_on, '%d/%m/%Y') as visa_validity_on from view_employee_expertiser_list order by employee_name asc");
   }
   else if($_GET["v_employee_type_id"]=='8')
   {
       if($_GET["v_emp_tech_type_name"]=='Both' && $_GET["v_expertise_id"]!="")
       {
        $result = mysqli_query($varDBConnection,"select *,DATE_FORMAT(joining_date, '%d/%m/%Y') as joining_date,DATE_FORMAT(cpr_expiry_date, '%d/%m/%Y') as cpr_expiry_date,DATE_FORMAT(visa_validity_on, '%d/%m/%Y') as visa_validity_on from 	view_employee_expertiser_list where employee_type_id ='".$_GET["v_employee_type_id"]."' and employee_id IN(SELECT employee_id FROM `tbl_technician_expertise` WHERE `expertise_id` IN ('".$_GET["v_expertise_id"]."')) order by employee_name asc");
       }
       else if($_GET["v_emp_tech_type_name"]=='Both' && $_GET["v_expertise_id"]=="")
       {
        $result = mysqli_query($varDBConnection,"select *,DATE_FORMAT(joining_date, '%d/%m/%Y') as joining_date,DATE_FORMAT(cpr_expiry_date, '%d/%m/%Y') as cpr_expiry_date,DATE_FORMAT(visa_validity_on, '%d/%m/%Y') as visa_validity_on from 	view_employee_expertiser_list where employee_type_id ='".$_GET["v_employee_type_id"]."' order by employee_name asc");
       }
       else if($_GET["v_emp_tech_type_name"]!='Both' && $_GET["v_expertise_id"]=="")
       {
        $result = mysqli_query($varDBConnection,"select *,DATE_FORMAT(joining_date, '%d/%m/%Y') as joining_date,DATE_FORMAT(cpr_expiry_date, '%d/%m/%Y') as cpr_expiry_date,DATE_FORMAT(visa_validity_on, '%d/%m/%Y') as visa_validity_on from 	view_employee_expertiser_list where employee_type_id ='".$_GET["v_employee_type_id"]."' and technician_type='".$_GET["v_emp_tech_type_name"]."' order by employee_name asc");
       }
       else 
       {
        $result = mysqli_query($varDBConnection,"select *,DATE_FORMAT(joining_date, '%d/%m/%Y') as joining_date,DATE_FORMAT(cpr_expiry_date, '%d/%m/%Y') as cpr_expiry_date,DATE_FORMAT(visa_validity_on, '%d/%m/%Y') as visa_validity_on from 	view_employee_expertiser_list where employee_type_id ='".$_GET["v_employee_type_id"]."' and technician_type='".$_GET["v_emp_tech_type_name"]."' and employee_id IN(SELECT employee_id FROM `tbl_technician_expertise` WHERE `expertise_id` IN ('".$_GET["v_expertise_id"]."')) order by employee_name asc");
       }
   }
   else
   {
	...
	<tr>
			...
			<td style="text-align: center;" width="300"><?PHP echo $row['expertise_name']; ?></td>
			...
			<td style="text-align: center;" width="100"><?PHP echo $row['visa_type']; ?></td>
			<td style="text-align: center;" width="100"><?PHP echo $row['blood_group']; ?></td>
