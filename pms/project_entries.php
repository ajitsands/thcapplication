...
<head>
	...
	<script src="../httpdocs_pms/user_js/add_projects_entries.js"></script>
	<script src="../httpdocs_pms/user_js/login.js"></script>
    ...
    function readURLedit(input) {
        if (input.files && input.files[0]) {
            ...
            reader.onload = function (e) {
                ...
                var doc_file_obj_edit = $("#session_image_edit")[0].files[0];
                    doc_file_edit= doc_file_obj_edit.name;
                    $("#hidden_image_show_edit").val($.trim(randomNum+'_'+doc_file_edit));
                    
                $("#div_preview_edit").show();
	...
	<div class="page-content">
		...
		<div class="content-wrapper">
			...
			<div class="content pt-0">
				...
				<?PHP 
					include_once('projects/add_project_entries_new.php');
				?>
