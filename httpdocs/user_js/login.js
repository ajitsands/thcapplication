$(document).ready(function(){
   ...
   // var v_but_login = $( '#btn_sign_in' ).ladda();
	...
	$( '#btn_login' ).click(function(){ 
				...
				$.post("../controller/login/login_controller.php",{action:'login',v_username:v_username,v_password:v_password}, function(result,status){
					//alert(result);
                ...
                { 
					...
					JSONPost(document.getElementById('login_form'),'Login','Login',v_username);
	 ...
	 $( '#btn_reset_password' ).click(function(){
		...
		if(v_new_password!=v_new_confirm_password)
		{
			...
			//$('#txt_old_password').val('');
				...
				$.post("../controller/login/login_controller.php",{action:'reset_password',v_password:v_new_password,v_user_id:v_user_id}, function(result,status){
	...
	// $('#btn_login').click(function(event){
		...
		// var v_username = $('#txt_login_username').val(); 
		// JSONPost(document.getElementById('login_form'),'Login','Save',v_username);
	// });
