$(document).ready(function(){
  var v_customer_id,v_customer_name,v_po_box,v_address,v_contact_no,v_attension,v_date,v_subject,v_description,v_quantity,v_unit,v_rate,v_discount,v_tax,v_reference_number,v_terms_and_condition,v_quotation_number,v_reference_number,v_terms_and_condition,v_list_of_quotation_table,v_quotation_child_id;
		...
		var v_btn_quotation_search = $( '#btn_quotation_search' ).ladda();
		 ...
		 //$( '#btn_quotation_generate' ).show();
		
		var v_list_of_quotation_table = $('#list_of_quotation').DataTable({});
		...
		var v_list_of_quotation_table_edit = $('#list_of_quotation_edit').DataTable({});
		...
		$("#txt_quantity,#txt_rate,#txt_discount,#txt_tax").change(function(){
...
// 			else{
				...
				// v_after_discount_amount=parseFloat(v_total)-parseFloat(v_discount_amount);
				// v_tax_amount=parseFloat(v_after_discount_amount)*parseFloat(v_tax)/100;
				// v_after_tax=parseFloat(v_after_discount_amount)+parseFloat(v_tax_amount);
		...
		//qoutation data insersion starts
				...
				// 	v_tax=$("#txt_tax").val();
					...
					//v_approved_by_id=$("#txt_approved_by_id").val();
					//v_approved_by_name=$("#txt_approved_by_name").val();
				
					//calculation starts
					
					//refrence number generation starts
					
					var quotation_date_split=v_quotation_date.split('-');
					//alert(quotation_date_split[0]+quotation_date_split[2]);
					...
					//reference number generation ends
                    ...
                    if(typeof v_customer_id === "undefined"||$.trim(v_po_box)===""||$.trim(v_address)===""||$.trim(v_contact_no)===""||$.trim(v_attension)===""||$.trim(v_quotation_date)===""||$.trim(v_subject)===""||$.trim(v_description)===""||$.trim(v_quantity)===""||$.trim(v_unit)===""||$.trim(v_rate)==="")
                    ...
                    {         
                         $.post("../controller/quotation/quotation_controller.php",{action:'add_quotation',v_customer_id:v_customer_id,v_customer_name:v_customer_name,v_po_box:v_po_box,v_address:v_address,v_contact_no:v_contact_no,v_attension:v_attension,v_quotation_date:v_quotation_date,v_subject:v_subject,v_description:v_description,v_quantity:v_quantity,v_unit:v_unit,v_rate:v_rate,v_discount:v_discount,v_tax:v_tax,v_quotation_number:v_quotation_number,v_total:v_total,v_grand_total:v_grand_total,v_created_by_id:v_created_by_id,v_created_by_name:v_created_by_name,v_approved_by_id:v_approved_by_id,v_approved_by_name:v_approved_by_name,reference_number_date:reference_number_date,v_vat_content:v_vat_content}
                                ...
                                {
                                     v_btn_quotation_add.ladda( 'stop' );
                                     //swal("Success", "New quotation added successfully..", "success");
		...
		//quotation data insertions ends
        ...
        //                          //{ "data": "discount","visible":false },
                ...
                v_btn_quotation_generate.click(function(){
				    ...
				    //alert(CKEDITOR.instances.txt_terms_and_condition.getData());
                    v_terms_and_condition=CKEDITOR.instances.txt_terms_and_condition.getData();
				
					//alert(v_terms_and_condition);
