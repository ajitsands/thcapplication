$(document).ready(function(){
 ...
 var v_product_master_id,v_product_master_status,product_type_id_combo_master,product_item_id_combo_master;
                    ...
                    $('#select_product_category_for_master_req').bind('change',function() {
                       ...
                       load_div_for_product_type_bind();
                         ...
                         function load_div_for_product_type_bind()
                         {
                             ...
                             var v_prdt_category_id_master=$("#select_product_category_for_master_req option:selected").val();
                            // alert(v_prdt_category_id_master);
                             $.ajax({
                    		type: "POST",
                    		url: "requisition/product_type_combo_master.php",
                    		data: { v_prdt_category_id_master : v_prdt_category_id_master } 
                    		 }).done(function(data){
                    		     
                    			 
                    			$("#div_list_product_type_req").html(data);
                    			$("#select_product_type_for_master_req").select2();
                    		    if(v_product_master_id!=='')
                            	{
                                    
                                	$("#select_product_type_for_master_req").val(product_type_id_combo_master).trigger("change");
                            	}
                    		 });
                         }
                         
                         
                        $("#div_list_product_type_req").change(function(){
                            //alert("jbf");
                            ...
                            function load_div_for_product_item_bind()
                         {
                             ...
                             var v_prdt_type_id_master=$("#select_product_type_for_master_req option:selected").val();
                             
                             $.ajax({
                    		type: "POST",
                    		url: "requisition/product_item_combo_master.php",
                    		data: { v_prdt_type_id_master : v_prdt_type_id_master } 
                    		 }).done(function(data){
                    		     
                    			 
                    			$("#div_list_product_item_req").html(data);
                    			$("#select_product_item_for_master_req").select2();
                    		    if(v_product_master_id!=='')
                            	{
                                    
                                	$("#select_product_item_for_master_req").val(product_item_id_combo_master).trigger("change");
                            	}
                    		 });
                         }
                    ...
                    v_btn_product_master_add.click(function(){
                                ...
                                var v_product_category_id_master=$("#select_product_category_for_master_req option:selected").val();
                                var v_product_category_name_master=$("#select_product_category_for_master_req option:selected").text();
                                var v_product_type_id_master=$("#select_product_type_for_master_req option:selected").val();
                                var v_product_type_name_master=$("#select_product_type_for_master_req option:selected").text();
                                var v_product_item_id_master=$("#select_product_item_for_master_req option:selected").val();
                                var v_product_item_name_master=$("#select_product_item_for_master_req option:selected").text();
                                var v_product_unit=$("#txt_product_unit_req").val();
                                var v_product_unit_rate=$("#txt_product_unit_rate_req").val();
                 ...
                 function load_div_for_product_brand_bind()
            			  ...
            			  function edit_product_master_details(v_product_master_id)
                            {
                                ...
                                $("#txt_product_unit_rate_req").val(product_master_data.product_unit_rate);
                                 $("#txt_product_unit_req").val(product_master_data.product_unit);
                                ...
                                product_item_id_combo_master=product_master_data.product_item_id
                                 ...
                                 $("#select_product_category_for_master_req").val(product_master_data.product_category_id).trigger("change");
                   ...
                   function clear_text()
                 {
                    $("#select_product_category_for_master_req").val(null).trigger("change");
                    $("#select_product_type_for_master_req").val(null).trigger("change");
                     $("#select_product_item_for_master_req").val(null).trigger("change");
                    $("#txt_product_unit_rate_req").val('');
                    $("#txt_product_unit_req").val('');
