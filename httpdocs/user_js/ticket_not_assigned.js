$(document).ready(function(){
       ...
       $('.modal').on("hidden.bs.modal", function (e) { //fire on closing modal box
        if ($('.modal:visible').length) { // check whether parent modal is opend after child modal close
            $('body').addClass('modal-open'); // if open mean length is 1 then add a bootstrap css class to body of the page
                    ...
                    var v_list_of_not_assigned_tickets = $('#tbl_of_not_assigned_tickets').DataTable({});
                      load_data_to_grid_not_assigned_ticket_list();
					  
           
                 function load_data_to_grid_not_assigned_ticket_list()
                 {
                     var i=1;
                    v_list_of_not_assigned_tickets.destroy();
                         
                     v_list_of_not_assigned_tickets = $('#tbl_of_not_assigned_tickets').DataTable( {
                           
                             "ajax": {
                                 'type': 'POST',
                                 'url': '../controller/ticket/ticket_not_assigned_controller.php',
                                 'data': {
                                    action: 'list_not_assigned_ticket'
                                    
                                 },
								  beforeSend: function () {
									$("#tbl_of_not_assigned_tickets").LoadingOverlay("show", {
										background: "rgba(132, 194, 0, 0.2)",
										text: "Loading..."
									});
                                  },
								    complete: function () {
									  $("#tbl_of_not_assigned_tickets").LoadingOverlay("hide");
								  },
                            ...
                            "columns": [
                                 ...
                                 { "data": "ticket_ref_code",
                                      render: function ( data, type, rows, meta ) {
                                        var dropdownOptions = {
                                            "WoScheduledModify": "View / Edit", 
                                            "WoScheduledModify": "Visit Schedules",
                                            "WoScheduledModify": "Assign Team",
                                            "WoScheduledModify": "Change Status"
                                        };
                                        ...
                                        if(filteredOptions=="WoScheduledModify")
                                          {
                                             dropdownHTML += '<a href="#" class="dropdown-item" name="view_ticket" data-toggle="modal" data-target="#modal_view_ticket" style="color: black;"><i class="icon-eye"></i> View / Edit</a><div class="dropdown-divider"></div><a href="#" class="dropdown-item" name="schedule_ticket_multiple" style="color: black;" data-toggle="modal" data-target="#modal_schedule_ticket_multiple"><i class="icon-calendar"></i>Visit Schedules </a><a href="#" class="dropdown-item" name="assign_ticket_multiple" style="color: black;" data-toggle="modal" data-target="#modal_assign_ticket_multiple"><i class="icon-collaboration"></i>Assign Team</a><div class="dropdown-divider"></div><a href="#" class="dropdown-item" name="change_status_ticket" style="color: black;" data-toggle="modal" data-target="#modal_change_status_ticket"><i class="icon-pencil5"></i> Change Status</a>'; 
                                          }
                                          else
                                          {
                                ...
                                //           str_active_status_edit = '<div class="list-icons"><div class="dropdown"><a href="#" class="list-icons-item" data-toggle="dropdown" style="color:black">	<i class="icon-menu9"></i>	</a>	<div class="dropdown-menu dropdown-menu-right">	<a href="#" class="dropdown-item" name="view_ticket" data-toggle="modal" data-target="#modal_view_ticket" style="color:black"><i class="icon-eye"></i> View / Edit</a><div class="dropdown-divider"></div><a href="#" class="dropdown-item" name="schedule_ticket_multiple" style="color:black" data-toggle="modal" data-target="#modal_schedule_ticket_multiple"><i class="icon-calendar"></i>Visit Schedules </a><a href="#" class="dropdown-item" name="assign_ticket_multiple" style="color:black" data-toggle="modal" data-target="#modal_assign_ticket_multiple"><i class="icon-collaboration"></i>Assign Team</a><div class="dropdown-divider"></div><a href="#" class="dropdown-item" name="change_status_ticket" style="color:black" data-toggle="modal" data-target="#modal_change_status_ticket"><i class="icon-pencil5"></i> Change Status</a></div></div></div>';
                ...
                //              "aoColumnDefs": [
                   ...
                   $('#tbl_of_not_assigned_tickets tbody').on('click', 'a', function(){
                        var $row = $(this).closest('tr');
                        var ticket_data = v_list_of_not_assigned_tickets.row($row).data();
               	...
               	swal({
						...
						.then((willDelete) => {
						  if (willDelete) {
                               ...
                               $.post("../controller/ticket/ticket_not_assigned_controller.php",{action:'change_status_ticket',ticket_ref_code:ticket_ref_code,remarks:remarks,status:status}
                                 ...
                                 { "data": "ticket_status",
                                     ...
                                     { "data": "ticket_ref_code",
                                      render: function ( data, type, rows, meta ) {
                                          ...
                                          str_active_status_edit = '<div class="list-icons"><div class="dropdown"><a href="#" class="list-icons-item" data-toggle="dropdown" style="color:black">	<i class="icon-menu9"></i>	</a>	<div class="dropdown-menu dropdown-menu-right"><a href="#" class="dropdown-item" name="cancel_complaint" style="color:black" data-toggle="modal" data-target="#modal_cancel_ticket_entry"><i class="icon-stack-cancel"></i> Cancel Work Order</a></div></div></div>';
                                          return str_active_status_edit;
  ...
  $('#btn_cancel_ticket_entry').click(function(){
       ...
       if(ticket_id=='')
         {
          ...
          if(cancel_reason=='')
         {
               swal("Warning", "Please provide cancel reason...", "warning");
         }
           else
           {
                               	...
                               	swal({
                						  title: "Are you sure to cancel the ticket entry?",
                						  text: "All associated visit entries will get cancelled?",
                						  icon: "warning",
                						  buttons: ['No, Cancel It!','Yes, Proceed!'],
                						  dangerMode: true,
                						})
                						.then((willDelete) => {
                						  if (willDelete) {
                                               ...
                                               $.post("../controller/ticket/ticket_not_assigned_controller.php",{action:'cancel_ticket_entry',ticket_id:ticket_id,cancel_reason:cancel_reason}
                           , function(result,status)
                             {
        ...
        if ( $(this).hasClass('selected') ) {
           ...
           // clear_view_controls();
            ...
            $('#txt_hidden_category_id_view_ticket').val(data.category_id);
             ...
             $('#txt_quote_ref_nos').val(data.quote_ref_no);
		...
		var SQLString ="Insert into tbl_ticket_services (ticket_id,ticket_ref_code,service_id,service_description,ticket_service_status) values ";
            ...
            SQLString =  SQLString.replace(/,\s*$/, "");
				...
				if($.trim(ticket_ref_code)==""||$.trim(ticket_id)=="")
    		        ...
    		        $.post("../controller/ticket/ticket_controller.php",{action:'update_ticket_entry',ticket_id:ticket_id,additional_info:additional_info,priority_val:priority_val,quote_val:quote_val,complaint_description:complaint_description,SQLString:SQLString,quote_date:quote_date,date_needed:date_needed,job_category:job_category,service_request:service_request,v_session_image:v_session_image1}
                       , function(result,status)
                        {
    ...
    $('#tbl_ticket_assign_category_list_multiple_extended tbody').on( 'click', 'tr', function () {
        if ( $(this).hasClass('selected') ) {
            ...
            var $row = $(this).closest('tr');
            var ids = v_ticket_assign_category_list_multiple_extended.row($row).data();
            $('#div_tech_list').hide();
     ...
     $('#btn_view_tech_avail_assign').click(function(){
         
          var ticket_assign_count = v_ticket_assign_category_list_multiple_extended.rows('.selected').data().length;
		
		  var ticketassignTableSelectedValues = $.map(v_ticket_assign_category_list_multiple_extended.rows('.selected').data(), function (item) {
			return item;
		}); 
        
        if(ticket_assign_count==0)
        {
        ...
        else
        {
           ...
           if(ticket_assign_count==1)
           {
                        $('#div_tech_list').show();
        			     var visit_date=ticketassignTableSelectedValues[0].date_of_visits1;
                                                 var visit_slot=ticketassignTableSelectedValues[0].time_of_visit;
                                                 var visit_duration=ticketassignTableSelectedValues[0].additional_slots;
                                                 var j=visit_slot;
                                                 var slot_sql_string="";
                                                 var k=parseInt(visit_slot)+parseInt(visit_duration);
        				                       for(j=visit_slot;j<=k;j++)
                                                 {
                                                      slot_sql_string=slot_sql_string+' slot_'+j+' ="0" and';
           ...
           {
                for(t=0;t<=ticket_assign_count-1;t++)
			    {
	                if(t!=0)
				    {
				       if(ticketassignTableSelectedValues[t].date_of_visits!=ticketassignTableSelectedValues[t-1].date_of_visits)
				       {
				             swal("Warning", "You have chosen different visit dates...", "warning");
                             return false; 
				       }
				       
			           if(ticketassignTableSelectedValues[t].time_of_visit!=ticketassignTableSelectedValues[t-1].time_of_visit)
			            {
			                swal("Warning", "You have chosen different start slots...", "warning");
                             return false; 
			            }
		                if(ticketassignTableSelectedValues[t].additional_slots!=ticketassignTableSelectedValues[t-1].additional_slots)
		                 {
		                     swal("Warning", "You have chosen different additional slots...", "warning");
                             return false; 
		                 } 
		                   else
				                 {
				                        $('#div_tech_list').show();
				                        var visit_date=ticketassignTableSelectedValues[t].date_of_visits1;
                                         var visit_slot=ticketassignTableSelectedValues[t].time_of_visit;
                                         var visit_duration=ticketassignTableSelectedValues[t].additional_slots;
                                         var j=visit_slot;
                                         var slot_sql_string="";
                                         var k=parseInt(visit_slot)+parseInt(visit_duration);
				                       for(j=visit_slot;j<=k;j++)
	   ...
	   var v_btn_assign_team = $('#btn_assign_team').ladda();
    $("#btn_assign_team").click(function(){
        
		v_btn_assign_team.ladda( 'start' );
		var leadr_emp_id;
		var ticket_ref_code=$('#txt_hidden_ticket_ref_code_assign_ticket_multiple1').val();
		...
		var ticket_selected_count = v_ticket_assign_category_list_multiple_extended.rows('.selected').data().length;
		
		  var ticketTableSelectedValues = $.map(v_ticket_assign_category_list_multiple_extended.rows('.selected').data(), function (item) {
			return item;
		}); 
		
		var tech_selected_count = v_list_of_techsavail_multiple.rows('.selected').data().length;
		
		var techTableSelectedValues = $.map(v_list_of_techsavail_multiple.rows('.selected').data(), function (item) {
			return item;
		}); 
		
		if(ticket_selected_count==0)
        {
            swal("Warning", "Please select the ticket entries...", "warning");
            v_btn_assign_team.ladda( 'stop' );
              return false; 
        }
        
        if(tech_selected_count==0)
        {
        ...
        else
        {
          ...
          var technamearray = [];
          var techcodearray = [];
          var techcontactnoarray = [];
          var visit_date;
          var visit_duration;
          var visit_slot;
          var visit_start_time;
                for(t=0;t<=ticket_selected_count-1;t++)
				{
				    
				     visitidarray.push(ticketTableSelectedValues[t].amc_visit_id);
				     ticketidarray.push(ticketTableSelectedValues[t].amc_tkt_id);
		        	visit_date=	ticketTableSelectedValues[t].date_of_visits1;
		        	visit_duration=	ticketTableSelectedValues[t].additional_slots;
		        	visit_start_time=ticketTableSelectedValues[t].visit_start_time;
		        	visit_slot=ticketTableSelectedValues[t].time_of_visit;
				}
				for(y=0;y<=tech_selected_count-1;y++)
				{
				     techidarray.push(techTableSelectedValues[y].employee_id);
				     technamearray.push(techTableSelectedValues[y].employee_name);
				     techcodearray.push(techTableSelectedValues[y].employee_code);
				     techcontactnoarray.push(techTableSelectedValues[y].employee_contact_no);
				
				}
    				var total_slots=parseInt(visit_slot)+parseInt(visit_duration);
                    ...
                    {
                        $.post("../controller/ticket/ticket_not_assigned_controller.php",{action:'assign_ticket_visit',visit_id:visitidarray,ticket_id:ticketidarray,employee_id:techidarray,employee_code:techcodearray,employee_name:technamearray,employee_contact_no:techcontactnoarray,ticket_count:ticket_selected_count,employee_count:tech_selected_count,visit_date:visit_date,ticket_ref_code:ticket_ref_code,visit_duration:visit_duration,visit_start_time:visit_start_time,visit_slot:visit_slot,leadr_emp_id:leadr_emp_id,total_slots:total_slots}
                          , function(result,status)
                             {
                                    ...
                                    if(status=='success')
                                        {
                                            ...
                                            location.reload();  //load_data_to_grid_ticket_assign_list_multiple_extended(ticket_ref_code);
                                    ...
                                    else 
                                        {
                                                ...
                                                swal("Error", "Sorry! Could not assign the team...", "error");
                                                 v_btn_assign_team.ladda( 'stop' );
                                                return false;
        ...
        else
        {
              var visitidarray = [];
                ...
                for(t=0;t<=ticket_sch_count-1;t++)
        			 ...
        			 $.post("../controller/ticket/ticket_not_assigned_controller.php",{action:'update_schedules',visit_id:visitidarray,visit_date:visit_date,visit_slot:visit_slot,visit_duration:visit_duration,total_slots:t,visit_start_time:visit_start_time,ticket_count:ticket_sch_count}
                           , function(result,status)
                             {
