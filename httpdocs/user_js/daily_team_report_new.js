$(document).ready(function(){
	...
	$("#btn_print_go").click(function(){
		...
		{
		    window.open('daily_reports/daily_team_tasks_print_date_range.php?start_date='+start_date+'&end_date='+end_date, '_blank'); 
		}
	}); 
    ...
    function list_daily_teams()
    {
		...
		if(start_date=='' )
		{
		    $("#load_div").LoadingOverlay("hide", true);
		    swal("Warning","Please specify the start date ...", "warning");
            return false;  
		}
		...
		else
		{
           ...
           $.ajax({
		type: "POST",
		url: "daily_reports/list_daily_teams_new_v1.php",
