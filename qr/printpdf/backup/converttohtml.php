...
//MakeFont('font/unifont/DejaVuSans-ExtraLight.ttf','cp1252');
...
class createPDF {
	...
	function run() {
		...
		$pdf=new PDFHTML('P','mm','A4',false);
            
    //         $pdf->AddFont('Symbol','','symbol.php');
    //     	$pdf->SetFont('Symbol','',10);
		  //  $pdf->fontlist=array('Symbol','Courier'); 
...
class PDFHTML extends FPDF
{
	...
	function __construct($orientation='P',$unit='mm',$format='A4',$_debug=false)
	{
		...
		//$this->AddFont('DejaVuSans','','DejaVuSans-ExtraLight.php');
...
// {
//     // Logo
//     $this->Image('blueprinthead.png',0,0,210);
//     // Arial bold 15
