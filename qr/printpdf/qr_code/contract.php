...
//$second_party_email_reverse = strrev ( $second_party_email );
//$out_put1 = str_replace($second_party_email,$second_party_email_reverse,$out_put);
...
$out_put_step4=str_replace('class="ql-align-right ql-direction-ltr"','style="text-align:left"',$out_put_step4);
...
<table width="95%" border="0"  cellpadding-left="30" cellpadding-right="30" cellspacing="0" border="0" style="text-align:justify;">
    ...
    <tr>
      <td>
            <p style="text-align:center">مـادة ( 15 )</p>
            <p style="text-align:center">نسخ العقد </p>
            <p  style="text-align:justify">حرر هذا العقد من نسختين باللغة العربية تعتبر كل منها نسخة أصلية وقد تسلم كل من الطرفين نسخة منها بعد التوقيع عليها للعمل بها عند اللزوم.</p>
    ...
    <tr>
        <td style="text-align:right">ممثل السلطة المرخصة لأغراض هذا الترخيص</td>
    </tr>
        ...
        <td style="text-align:right">
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tbody>
                        ...
                        <tr>
                            <td>الاسم : $witness1_name</td>
                            <td>الاسم : $witness2_name </td>
                        </tr>
                        <tr>
                            <td>التوقيع :</td>
                            <td>التوقيع :</td>
